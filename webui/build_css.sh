...
npx purgecss --css dist/styles_.css --content 'dist/*.html' --content 'dist/langs/*.html' --content 'dist/myanimelist/*.html' --content 'dist/*.js' --rejected | jq '.[0].rejected'
npx purgecss --css dist/styles_.css --content 'dist/*.html' --content 'dist/langs/*.html' --content 'dist/myanimelist/*.html' --content 'dist/*.js' -o dist/styles.css
